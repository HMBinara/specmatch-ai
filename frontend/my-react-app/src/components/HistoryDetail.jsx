...
export default function HistoryDetail({ report, onBack }) {
    ...
    return (
        <div className="space-y-6 animate-fadeUp">
            <button
                onClick={onBack}
                className="flex items-center gap-2 text-sm text-[#8b93a0] hover:text-[#eef0f3] transition-colors"
            >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#2c313a] pb-4 mb-6">
                    ...
                    {!showMatch && (
                        <button
                            ...
                            className="bg-[#fbbf24] text-[#0b0e12] text-sm font-700 px-5 py-2.5 rounded-lg hover:bg-[#ffd35c] transition-all flex items-center gap-2"
                        >
            ...
            {showMatch && (
                <div ref={matchRef} className="space-y-6 animate-fadeUp">
